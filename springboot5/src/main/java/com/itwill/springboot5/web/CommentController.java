...
public class CommentController {
	...
	public ResponseEntity<Page<Comment>> getAllComments(@PathVariable(name = "postId") Long postId, 
			@RequestParam(name = "p",defaultValue = "0") int pageNo){
		log.info("getAllComments(postId = {}, pageNo ={})",postId,pageNo);
